...
| 6+ | participants → sales → analytics(Analytics Engine/KV)→ media/admin | participants 2e 已實作(2026-08-31):付費 access gate + 5 級遮罩 + event override + view log + contact stub;rust contract 17+4(本 sandbox 待主線實跑);其餘待開始 |
