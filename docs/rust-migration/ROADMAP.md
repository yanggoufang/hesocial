...
| 6+ | participants → sales → analytics(Analytics Engine/KV)→ media/admin | participants 2e 已實作(2026-08-31):付費 access gate + 5 級遮罩 + event override + view log + contact stub;sales CRM 2f 已實作(2026-08-31):leads CRUD、opportunities CRUD + stage 轉換、activities、pipeline/team 唯讀、metrics 聚合,`authenticateToken` 全域 + 僅 delete 要 admin;analytics 2g 已實作(2026-08-31):12 端點(6 AE 讀 via stub、1 beacon POST、5 D1),`ANALYTICS_QUERY_STUB` stub gating,contract rust 41/41、express 20/7、core 93/93;media/admin 待開始 |
