...
| 6+ | participants → sales → analytics(Analytics Engine/KV)→ media/admin | participants 2e 已實作(2026-08-31):付費 access gate + 5 級遮罩 + event override + view log + contact stub;sales CRM 2f 已實作(2026-08-31):leads CRUD、opportunities CRUD + stage 轉換、activities、pipeline/team 唯讀、metrics 聚合,`authenticateToken` 全域 + 僅 delete 要 admin;contract rust 37/37(21 舊 + 10 雙 target sales + 6 Rust-only flow)、express 16 passed/7 skipped;analytics/media/admin 待開始 |
